...
@:native("net.minecraft.world.inventory.DispenserMenu")
@:mapping("net.minecraft.class_1716")
extern class DispenserMenu extends net.minecraft.world.inventory.AbstractContainerMenu
{
