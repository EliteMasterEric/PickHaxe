...
@:native("net.minecraft.world.level.block.LeverBlock")
@:mapping("net.minecraft.class_2401")
extern class LeverBlock extends net.minecraft.world.level.block.FaceAttachedHorizontalDirectionalBlock
{
  @:mapping("field_11265")
  ...
  @:mapping("method_21846")
  public function pull(state:net.minecraft.world.level.block.state.BlockState, level:net.minecraft.world.level.Level,
