...
@:native("net.minecraft.world.level.block.DaylightDetectorBlock")
@:mapping("net.minecraft.class_2309")
extern class DaylightDetectorBlock extends net.minecraft.world.level.block.BaseEntityBlock
{
  @:mapping("field_10897")
  public static final POWER:net.minecraft.world.level.block.state.properties.IntegerProperty;
  @:mapping("field_10899")
  public static final INVERTED:net.minecraft.world.level.block.state.properties.BooleanProperty;
