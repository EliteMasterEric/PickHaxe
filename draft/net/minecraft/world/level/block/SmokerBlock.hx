...
@:native("net.minecraft.world.level.block.SmokerBlock")
@:mapping("net.minecraft.class_3716")
extern class SmokerBlock extends net.minecraft.world.level.block.AbstractFurnaceBlock
{
