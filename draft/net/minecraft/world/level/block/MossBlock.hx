...
@:native("net.minecraft.world.level.block.MossBlock")
@:mapping("net.minecraft.class_5807")
extern class MossBlock extends net.minecraft.world.level.block.Block implements net.minecraft.world.level.block.BonemealableBlock
{
