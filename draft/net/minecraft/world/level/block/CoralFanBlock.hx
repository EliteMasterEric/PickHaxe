...
@:native("net.minecraft.world.level.block.CoralFanBlock")
@:mapping("net.minecraft.class_2297")
extern class CoralFanBlock extends net.minecraft.world.level.block.BaseCoralFanBlock
{
