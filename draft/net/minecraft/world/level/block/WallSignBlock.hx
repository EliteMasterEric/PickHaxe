...
@:native("net.minecraft.world.level.block.WallSignBlock")
@:mapping("net.minecraft.class_2551")
extern class WallSignBlock extends net.minecraft.world.level.block.SignBlock
{
  @:mapping("field_11726")
