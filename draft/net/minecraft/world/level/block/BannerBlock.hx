...
@:native("net.minecraft.world.level.block.BannerBlock")
@:mapping("net.minecraft.class_2215")
extern class BannerBlock extends net.minecraft.world.level.block.AbstractBannerBlock
{
  @:mapping("field_9924")
  ...
  @:mapping("method_9398")
  public static function byColor(color:net.minecraft.world.item.DyeColor):net.minecraft.world.level.block.Block;
}
