...
@:native("net.minecraft.world.level.block.SoulSandBlock")
@:mapping("net.minecraft.class_2492")
extern class SoulSandBlock extends net.minecraft.world.level.block.Block
{
