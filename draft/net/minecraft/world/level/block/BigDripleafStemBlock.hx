...
@:native("net.minecraft.world.level.block.BigDripleafStemBlock")
@:mapping("net.minecraft.class_5802")
extern class BigDripleafStemBlock extends net.minecraft.world.level.block.HorizontalDirectionalBlock
    implements net.minecraft.world.level.block.BonemealableBlock implements net.minecraft.world.level.block.SimpleWaterloggedBlock
{
