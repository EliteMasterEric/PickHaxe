...
@:native("net.minecraft.world.level.block.MangroveLeavesBlock")
@:mapping("net.minecraft.class_7114")
extern class MangroveLeavesBlock extends net.minecraft.world.level.block.LeavesBlock implements net.minecraft.world.level.block.BonemealableBlock
{
