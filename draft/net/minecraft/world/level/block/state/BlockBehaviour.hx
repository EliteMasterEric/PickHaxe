...
abstract extern class BlockBehaviour implements net.minecraft.world.flag.FeatureElement
{
  ...
  @:mapping("method_9575")
  public function getShadeBrightness(state:net.minecraft.world.level.block.state.BlockState, level:net.minecraft.world.level.BlockGetter, pos:net.minecraft.core.BlockPos):Float;
  /**
   ...
   */
  @:mapping("method_9594")
  public function getDestroyProgress(state:net.minecraft.world.level.block.state.BlockState, player:net.minecraft.world.entity.player.Player, level:net.minecraft.world.level.BlockGetter, pos:net.minecraft.core.BlockPos):Float;
  /**
  ...
  public function defaultDestroyTime():Float;
}
...
extern class BlockBehaviour_Properties
{
  ...
  @:mapping("method_9628")
  public function friction(friction:Float):net.minecraft.world.level.block.state.BlockBehaviour.Properties;
  @:mapping("method_23351")
  public function speedFactor(speedFactor:Float):net.minecraft.world.level.block.state.BlockBehaviour.Properties;
  @:mapping("method_23352")
  public function jumpFactor(jumpFactor:Float):net.minecraft.world.level.block.state.BlockBehaviour.Properties;
  @:mapping("method_9626")
  ...
  @:mapping("method_9629")
  public overload function strength(destroyTime:Float, explosionResistance:Float):net.minecraft.world.level.block.state.BlockBehaviour.Properties;
  @:mapping("method_9618")
  public function instabreak():net.minecraft.world.level.block.state.BlockBehaviour.Properties;
  @:mapping("method_9632")
  public overload function strength(strength:Float):net.minecraft.world.level.block.state.BlockBehaviour.Properties;
  @:mapping("method_9640")
  ...
  public function destroyTime(destroyTime:Float):net.minecraft.world.level.block.state.BlockBehaviour.Properties;
  @:mapping("method_36558")
  public function explosionResistance(explosionResistance:Float):net.minecraft.world.level.block.state.BlockBehaviour.Properties;
...
abstract extern class BlockBehaviour_BlockStateBase extends net.minecraft.world.level.block.state.StateHolder<net.minecraft.world.level.block.Block,net.minecraft.world.level.block.state.BlockState>
{
  ...
  public function getShadeBrightness(level:net.minecraft.world.level.BlockGetter, pos:net.minecraft.core.BlockPos):Float;
  ...
  public function getDestroySpeed(level:net.minecraft.world.level.BlockGetter, pos:net.minecraft.core.BlockPos):Float;
  @:mapping("method_26165")
  public function getDestroyProgress(player:net.minecraft.world.entity.player.Player, level:net.minecraft.world.level.BlockGetter, pos:net.minecraft.core.BlockPos):Float;
