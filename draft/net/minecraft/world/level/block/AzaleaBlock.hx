...
@:native("net.minecraft.world.level.block.AzaleaBlock")
@:mapping("net.minecraft.class_5800")
extern class AzaleaBlock extends net.minecraft.world.level.block.BushBlock implements net.minecraft.world.level.block.BonemealableBlock
{
