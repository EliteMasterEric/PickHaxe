...
@:native("net.minecraft.world.level.block.BarrelBlock")
@:mapping("net.minecraft.class_3708")
extern class BarrelBlock extends net.minecraft.world.level.block.BaseEntityBlock
{
  @:mapping("field_16320")
