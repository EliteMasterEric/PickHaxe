...
@:native("net.minecraft.world.level.block.FlowerPotBlock")
@:mapping("net.minecraft.class_2362")
extern class FlowerPotBlock extends net.minecraft.world.level.block.Block
{
  @:mapping("field_31095")
  public static final AABB_SIZE:Float;
  ...
  @:mapping("method_16231")
  public function getContent():net.minecraft.world.level.block.Block;
  @:mapping("method_9516")
