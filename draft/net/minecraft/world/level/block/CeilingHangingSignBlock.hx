...
@:native("net.minecraft.world.level.block.CeilingHangingSignBlock")
@:mapping("net.minecraft.class_7713")
extern class CeilingHangingSignBlock extends net.minecraft.world.level.block.SignBlock
{
  @:mapping("field_40300")
