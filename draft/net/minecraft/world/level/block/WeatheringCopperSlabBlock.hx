...
@:native("net.minecraft.world.level.block.WeatheringCopperSlabBlock")
@:mapping("net.minecraft.class_5813")
extern class WeatheringCopperSlabBlock extends net.minecraft.world.level.block.SlabBlock implements net.minecraft.world.level.block.WeatheringCopper
{
