...
@:native("net.minecraft.world.level.block.SugarCaneBlock")
@:mapping("net.minecraft.class_2523")
extern class SugarCaneBlock extends net.minecraft.world.level.block.Block
{
  @:mapping("field_11610")
