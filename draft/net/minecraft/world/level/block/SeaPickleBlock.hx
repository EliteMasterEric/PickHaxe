...
@:native("net.minecraft.world.level.block.SeaPickleBlock")
@:mapping("net.minecraft.class_2472")
extern class SeaPickleBlock extends net.minecraft.world.level.block.BushBlock implements net.minecraft.world.level.block.BonemealableBlock
    implements net.minecraft.world.level.block.SimpleWaterloggedBlock
{
  @:mapping("field_31241")
  public static final MAX_PICKLES:Int;
  @:mapping("field_11472")
  public static final PICKLES:net.minecraft.world.level.block.state.properties.IntegerProperty;
  @:mapping("field_11475")
  ...
  @:mapping("method_10506")
  public static function isDead(state:net.minecraft.world.level.block.state.BlockState):Bool;
