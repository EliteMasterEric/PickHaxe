...
@:native("net.minecraft.world.level.block.StonecutterBlock")
@:mapping("net.minecraft.class_3718")
extern class StonecutterBlock extends net.minecraft.world.level.block.Block
{
  @:mapping("field_17649")
