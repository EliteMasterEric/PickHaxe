...
@:native("net.minecraft.world.level.block.WallTorchBlock")
@:mapping("net.minecraft.class_2555")
extern class WallTorchBlock extends net.minecraft.world.level.block.TorchBlock
{
  @:mapping("field_11731")
  ...
  @:mapping("method_9530")
  public overload function getShape(state:net.minecraft.world.level.block.state.BlockState, level:net.minecraft.world.level.BlockGetter,
    pos:net.minecraft.core.BlockPos, context:net.minecraft.world.phys.shapes.CollisionContext):net.minecraft.world.phys.shapes.VoxelShape;
  @:mapping("method_10841")
  public static overload function getShape(state:net.minecraft.world.level.block.state.BlockState):net.minecraft.world.phys.shapes.VoxelShape;
  @:mapping("method_9558")
