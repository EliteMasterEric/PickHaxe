...
@:native("net.minecraft.world.level.block.NetherrackBlock")
@:mapping("net.minecraft.class_4773")
extern class NetherrackBlock extends net.minecraft.world.level.block.Block implements net.minecraft.world.level.block.BonemealableBlock
{
