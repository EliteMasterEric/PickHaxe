...
@:native("net.minecraft.world.level.block.NetherPortalBlock")
@:mapping("net.minecraft.class_2423")
extern class NetherPortalBlock extends net.minecraft.world.level.block.Block
{
  @:mapping("field_11310")
