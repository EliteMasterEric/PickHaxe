...
@:native("net.minecraft.world.level.block.DirtPathBlock")
@:mapping("net.minecraft.class_2369")
extern class DirtPathBlock extends net.minecraft.world.level.block.Block
{
