...
@:native("net.minecraft.world.level.block.SweetBerryBushBlock")
@:mapping("net.minecraft.class_3830")
extern class SweetBerryBushBlock extends net.minecraft.world.level.block.BushBlock implements net.minecraft.world.level.block.BonemealableBlock
{
  @:mapping("field_31259")
