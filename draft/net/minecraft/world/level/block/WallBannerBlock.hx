...
@:native("net.minecraft.world.level.block.WallBannerBlock")
@:mapping("net.minecraft.class_2546")
extern class WallBannerBlock extends net.minecraft.world.level.block.AbstractBannerBlock
{
  @:mapping("field_11722")
