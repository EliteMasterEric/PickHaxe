...
@:native("net.minecraft.world.level.block.CactusBlock")
@:mapping("net.minecraft.class_2266")
extern class CactusBlock extends net.minecraft.world.level.block.Block
{
  @:mapping("field_10709")
