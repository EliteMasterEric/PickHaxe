...
@:native("net.minecraft.world.level.levelgen.structure.templatesystem.LavaSubmergedBlockProcessor")
@:mapping("net.minecraft.class_5399")
extern class LavaSubmergedBlockProcessor extends net.minecraft.world.level.levelgen.structure.templatesystem.StructureProcessor
{
  public function new();
  @:mapping("field_25618")
  public static final CODEC:com.mojang.serialization.Codec<net.minecraft.world.level.levelgen.structure.templatesystem.LavaSubmergedBlockProcessor>;
  @:mapping("field_25619")
  public static final INSTANCE:net.minecraft.world.level.levelgen.structure.templatesystem.LavaSubmergedBlockProcessor;
