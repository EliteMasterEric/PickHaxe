...
@:native("net.minecraft.world.level.levelgen.structure.templatesystem.RuleProcessor")
@:mapping("net.minecraft.class_3826")
extern class RuleProcessor extends net.minecraft.world.level.levelgen.structure.templatesystem.StructureProcessor
{
  @:mapping("field_25011")
  public static final CODEC:com.mojang.serialization.Codec<net.minecraft.world.level.levelgen.structure.templatesystem.RuleProcessor>;

  public function new(list:java.util.List<net.minecraft.world.level.levelgen.structure.templatesystem.ProcessorRule>);
