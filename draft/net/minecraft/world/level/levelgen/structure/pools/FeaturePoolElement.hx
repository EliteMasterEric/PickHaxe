...
@:native("net.minecraft.world.level.levelgen.structure.pools.FeaturePoolElement")
@:mapping("net.minecraft.class_3776")
extern class FeaturePoolElement extends net.minecraft.world.level.levelgen.structure.pools.StructurePoolElement
{
  @:mapping("field_24948")
  public static final CODEC:com.mojang.serialization.Codec<net.minecraft.world.level.levelgen.structure.pools.FeaturePoolElement>;
