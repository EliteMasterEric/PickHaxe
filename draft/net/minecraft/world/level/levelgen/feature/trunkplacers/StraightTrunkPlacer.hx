...
@:native("net.minecraft.world.level.levelgen.feature.trunkplacers.StraightTrunkPlacer")
@:mapping("net.minecraft.class_5140")
extern class StraightTrunkPlacer extends net.minecraft.world.level.levelgen.feature.trunkplacers.TrunkPlacer
{
  @:mapping("field_24971")
  public static final CODEC:com.mojang.serialization.Codec<net.minecraft.world.level.levelgen.feature.trunkplacers.StraightTrunkPlacer>;
