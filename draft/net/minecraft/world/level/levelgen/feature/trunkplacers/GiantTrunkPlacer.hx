...
@:native("net.minecraft.world.level.levelgen.feature.trunkplacers.GiantTrunkPlacer")
@:mapping("net.minecraft.class_5214")
extern class GiantTrunkPlacer extends net.minecraft.world.level.levelgen.feature.trunkplacers.TrunkPlacer
{
  @:mapping("field_24969")
  public static final CODEC:com.mojang.serialization.Codec<net.minecraft.world.level.levelgen.feature.trunkplacers.GiantTrunkPlacer>;
