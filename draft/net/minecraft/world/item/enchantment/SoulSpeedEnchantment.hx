...
@:native("net.minecraft.world.item.enchantment.SoulSpeedEnchantment")
@:mapping("net.minecraft.class_4948")
extern class SoulSpeedEnchantment extends net.minecraft.world.item.enchantment.Enchantment
{
