...
@:native("net.minecraft.world.item.enchantment.ArrowDamageEnchantment")
@:mapping("net.minecraft.class_1878")
extern class ArrowDamageEnchantment extends net.minecraft.world.item.enchantment.Enchantment
{
