...
@:native("net.minecraft.world.item.enchantment.TridentChannelingEnchantment")
@:mapping("net.minecraft.class_1905")
extern class TridentChannelingEnchantment extends net.minecraft.world.item.enchantment.Enchantment
{
