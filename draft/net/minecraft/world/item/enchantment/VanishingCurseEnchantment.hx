...
@:native("net.minecraft.world.item.enchantment.VanishingCurseEnchantment")
@:mapping("net.minecraft.class_1911")
extern class VanishingCurseEnchantment extends net.minecraft.world.item.enchantment.Enchantment
{
