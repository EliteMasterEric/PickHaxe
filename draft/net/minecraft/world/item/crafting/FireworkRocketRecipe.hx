...
@:native("net.minecraft.world.item.crafting.FireworkRocketRecipe")
@:mapping("net.minecraft.class_1851")
extern class FireworkRocketRecipe extends net.minecraft.world.item.crafting.CustomRecipe
{
