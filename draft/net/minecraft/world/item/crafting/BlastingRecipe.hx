...
@:native("net.minecraft.world.item.crafting.BlastingRecipe")
@:mapping("net.minecraft.class_3859")
extern class BlastingRecipe extends net.minecraft.world.item.crafting.AbstractCookingRecipe
{
