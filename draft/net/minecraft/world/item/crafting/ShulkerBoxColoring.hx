...
@:native("net.minecraft.world.item.crafting.ShulkerBoxColoring")
@:mapping("net.minecraft.class_1871")
extern class ShulkerBoxColoring extends net.minecraft.world.item.crafting.CustomRecipe
{
