...
@:native("net.minecraft.world.item.crafting.SmokingRecipe")
@:mapping("net.minecraft.class_3862")
extern class SmokingRecipe extends net.minecraft.world.item.crafting.AbstractCookingRecipe
{
