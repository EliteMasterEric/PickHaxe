...
@:native("net.minecraft.nbt.TextComponentTagVisitor")
@:mapping("net.minecraft.class_5628")
extern class TextComponentTagVisitor implements net.minecraft.nbt.TagVisitor
{
  public function new(string:String, i:Int);
  @:mapping("method_32305")
  public function visit(tag:net.minecraft.nbt.Tag):net.minecraft.network.chat.Component;
