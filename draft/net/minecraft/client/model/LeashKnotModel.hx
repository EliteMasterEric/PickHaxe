...
@:native("net.minecraft.client.model.LeashKnotModel")
@:mapping("net.minecraft.class_579")
extern class LeashKnotModel<T:net.minecraft.world.entity.Entity> extends net.minecraft.client.model.HierarchicalModel<T>
{
  public function new(modelPart:net.minecraft.client.model.geom.ModelPart);
  @:mapping("method_32017")
