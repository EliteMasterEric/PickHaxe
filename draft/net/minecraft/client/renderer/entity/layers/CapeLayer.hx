...
@:native("net.minecraft.client.renderer.entity.layers.CapeLayer")
@:mapping("net.minecraft.class_972")
extern class CapeLayer extends net.minecraft.client.renderer.entity.layers.RenderLayer<net.minecraft.client.player.AbstractClientPlayer,
