...
@:native("net.minecraft.client.renderer.entity.layers.HorseArmorLayer")
@:mapping("net.minecraft.class_4073")
extern class HorseArmorLayer extends net.minecraft.client.renderer.entity.layers.RenderLayer<net.minecraft.world.entity.animal.horse.Horse,
