...
@:native("net.minecraft.client.renderer.debug.SolidFaceRenderer")
@:mapping("net.minecraft.class_871")
extern class SolidFaceRenderer implements net.minecraft.client.renderer.debug.DebugRenderer.SimpleDebugRenderer
{
