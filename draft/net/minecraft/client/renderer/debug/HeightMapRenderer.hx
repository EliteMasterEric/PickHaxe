...
@:native("net.minecraft.client.renderer.debug.HeightMapRenderer")
@:mapping("net.minecraft.class_867")
extern class HeightMapRenderer implements net.minecraft.client.renderer.debug.DebugRenderer.SimpleDebugRenderer
{
