...
@:native("net.minecraft.client.renderer.debug.WaterDebugRenderer")
@:mapping("net.minecraft.class_872")
extern class WaterDebugRenderer implements net.minecraft.client.renderer.debug.DebugRenderer.SimpleDebugRenderer
{
