...
@:native("net.minecraft.server.network.ServerHandshakePacketListenerImpl")
@:mapping("net.minecraft.class_3246")
extern class ServerHandshakePacketListenerImpl implements net.minecraft.network.protocol.handshake.ServerHandshakePacketListener
{
