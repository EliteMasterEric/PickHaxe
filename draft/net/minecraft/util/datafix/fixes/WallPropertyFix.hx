...
@:native("net.minecraft.util.datafix.fixes.WallPropertyFix")
@:mapping("net.minecraft.class_4754")
extern class WallPropertyFix extends com.mojang.datafixers.DataFix
{
