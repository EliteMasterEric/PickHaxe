...
@:native("net.minecraft.util.datafix.fixes.ChunkToProtochunkFix")
@:mapping("net.minecraft.class_3591")
extern class ChunkToProtochunkFix extends com.mojang.datafixers.DataFix
{
