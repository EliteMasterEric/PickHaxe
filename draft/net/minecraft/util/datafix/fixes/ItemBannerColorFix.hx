...
@:native("net.minecraft.util.datafix.fixes.ItemBannerColorFix")
@:mapping("net.minecraft.class_1179")
extern class ItemBannerColorFix extends com.mojang.datafixers.DataFix
{
