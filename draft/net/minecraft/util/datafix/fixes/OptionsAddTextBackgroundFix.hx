...
@:native("net.minecraft.util.datafix.fixes.OptionsAddTextBackgroundFix")
@:mapping("net.minecraft.class_4092")
extern class OptionsAddTextBackgroundFix extends com.mojang.datafixers.DataFix
{
