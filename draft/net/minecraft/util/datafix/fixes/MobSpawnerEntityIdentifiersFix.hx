...
@:native("net.minecraft.util.datafix.fixes.MobSpawnerEntityIdentifiersFix")
@:mapping("net.minecraft.class_1198")
extern class MobSpawnerEntityIdentifiersFix extends com.mojang.datafixers.DataFix
{
