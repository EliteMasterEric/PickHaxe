...
extern class FabricItemGroupEntries implements net.minecraft.world.item.CreativeModeTab.Output {
	function new(enabledFeatures:net.minecraft.world.flag.FeatureFlagSet, displayStacks:java.util.List<net.minecraft.world.item.ItemStack>, searchTabStacks:java.util.List<net.minecraft.world.item.ItemStack>, showOpRestrictedItems:Bool):Void;
  ...
  overload function accept(item:net.minecraft.world.level.ItemLike, visibility:net.minecraft.world.item.CreativeModeTab.TabVisibility):Void;

  overload function accept(stack:net.minecraft.world.item.ItemStack):Void;

  overload function accept(stack:net.minecraft.world.item.ItemStack, visibility:net.minecraft.world.item.CreativeModeTab.TabVisibility):Void;

  overload function acceptAll(stacks:java.util.Collection<net.minecraft.world.item.ItemStack>):Void;

  overload function acceptAll(stacks:java.util.Collection<net.minecraft.world.item.ItemStack>, visibility:net.minecraft.world.item.CreativeModeTab.TabVisibility):Void;
  ...
  overload extern inline function addAll(stacks:java.util.Collection<net.minecraft.world.item.ItemStack>, visibility:net.minecraft.world.item.CreativeModeTab.TabVisibility):Void {
