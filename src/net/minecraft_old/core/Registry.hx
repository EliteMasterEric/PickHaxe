...
extern interface Registry<T>
{
  ...
  public function getRandom(var1:net.minecraft.util.RandomSource):java.util.Optional<net.minecraft.core.Holder.Reference<T>>;
  ...
  public static overload function registerForHolder<T>(registry:net.minecraft.core.Registry<T>, key:net.minecraft.resources.ResourceKey<T>,
    value:T):net.minecraft.core.Holder.Reference<T>;
  @:badMapping("unknownMethodMapping")
  ...
  @:badMapping("unknownMethodMapping")
  public function createIntrusiveHolder(var1:T):net.minecraft.core.Holder.Reference<T>;
  public overload function getHolder(var1:Int):java.util.Optional<net.minecraft.core.Holder.Reference<T>>;
  public overload function getHolder(var1:net.minecraft.resources.ResourceKey<T>):java.util.Optional<net.minecraft.core.Holder.Reference<T>>;
  @:badMapping("unknownMethodMapping")
  public function wrapAsHolder(var1:T):net.minecraft.core.Holder<T>;
  public function getHolderOrThrow(key:net.minecraft.resources.ResourceKey<T>):net.minecraft.core.Holder.Reference<T>;
  public function holders():java.util.stream.Stream<net.minecraft.core.Holder.Reference<T>>;
