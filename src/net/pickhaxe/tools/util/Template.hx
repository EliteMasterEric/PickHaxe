...
class Template
{
  ...
  public static function applyPickHaxeDefines(input:String, defines:PickHaxeDefines):String
  {
    ...
    if (defines.pickhaxe.loader.fabric.apiVersion != null) result = result.replace('#{pickhaxe.loader.fabric.apiVersion}',
      defines.pickhaxe.loader.fabric.apiVersion);
    if (defines.pickhaxe.loader.fabric.loaderVersion != null) result = result.replace('#{pickhaxe.loader.fabric.loaderVersion}',
      defines.pickhaxe.loader.fabric.loaderVersion);
    if (defines.pickhaxe.loader.forge.apiVersion != null) result = result.replace('#{pickhaxe.loader.forge.apiVersion}',
      defines.pickhaxe.loader.forge.apiVersion);
    if (defines.pickhaxe.loader.forge.fmlVersion != null) result = result.replace('#{pickhaxe.loader.forge.fmlVersion}',
      defines.pickhaxe.loader.forge.fmlVersion);
    if (defines.pickhaxe.mappings.intermediary.maven != null) result = result.replace('#{pickhaxe.mappings.intermediary.maven}',
      defines.pickhaxe.mappings.intermediary.maven);
    if (defines.pickhaxe.mappings.intermediary.version != null) result = result.replace('#{pickhaxe.mappings.intermediary.version}',
      defines.pickhaxe.mappings.intermediary.version);
    if (defines.pickhaxe.mappings.parchment.maven != null) result = result.replace('#{pickhaxe.mappings.parchment.maven}',
      defines.pickhaxe.mappings.parchment.maven);
    if (defines.pickhaxe.mappings.parchment.version != null) result = result.replace('#{pickhaxe.mappings.parchment.version}',
      defines.pickhaxe.mappings.parchment.version);
  ...
  {
    var mixinNamesBoth:Array<String> = mixin.mixinClasses.filter((mixinClass) -> (mixinClass?.mixinType ?? Environment.BOTH) == Environment.BOTH)
      .map((mixinClass) -> mixinClass.value);

    var mixinNamesClient:Array<String> = mixin.mixinClasses.filter((mixinClass) -> (mixinClass?.mixinType ?? Environment.BOTH) == Environment.CLIENT)
      .map((mixinClass) -> mixinClass.value);

    var mixinNamesServer:Array<String> = mixin.mixinClasses.filter((mixinClass) -> (mixinClass?.mixinType ?? Environment.BOTH) == Environment.SERVER)
      .map((mixinClass) -> mixinClass.value);
