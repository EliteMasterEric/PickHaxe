...
@:native("net.minecraft.nbt.SnbtPrinterTagVisitor")
@:mapping("net.minecraft.class_5625")
extern class SnbtPrinterTagVisitor implements net.minecraft.nbt.TagVisitor
{
  public overload function new();
  public overload function new(string:String, i:Int, list:java.util.List<String>);
  @:mapping("method_32283")
