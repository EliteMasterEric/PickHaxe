...
@:native("net.minecraft.nbt.visitors.CollectToTag")
@:mapping("net.minecraft.class_6844")
extern class CollectToTag implements net.minecraft.nbt.StreamTagVisitor
{
  public function new();

  @:mapping("method_39887")
  public function getResult():Null<net.minecraft.nbt.Tag>;
