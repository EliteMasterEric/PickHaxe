...
@:native("net.minecraft.client.model.BlazeModel")
@:mapping("net.minecraft.class_555")
extern class BlazeModel<T:net.minecraft.world.entity.Entity> extends net.minecraft.client.model.HierarchicalModel<T>
{
  public function new(modelPart:net.minecraft.client.model.geom.ModelPart);

  @:mapping("method_31982")
