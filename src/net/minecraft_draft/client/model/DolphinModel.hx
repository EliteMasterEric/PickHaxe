...
@:native("net.minecraft.client.model.DolphinModel")
@:mapping("net.minecraft.class_889")
extern class DolphinModel<T:net.minecraft.world.entity.Entity> extends net.minecraft.client.model.HierarchicalModel<T>
{
  public function new(modelPart:net.minecraft.client.model.geom.ModelPart);
  @:mapping("method_31992")
