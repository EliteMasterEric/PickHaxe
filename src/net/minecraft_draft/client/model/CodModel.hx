...
@:native("net.minecraft.client.model.CodModel")
@:mapping("net.minecraft.class_561")
extern class CodModel<T:net.minecraft.world.entity.Entity> extends net.minecraft.client.model.HierarchicalModel<T>
{
  public function new(modelPart:net.minecraft.client.model.geom.ModelPart);
  @:mapping("method_31989")
