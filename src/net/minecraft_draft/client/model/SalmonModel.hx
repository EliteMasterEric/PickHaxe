...
@:native("net.minecraft.client.model.SalmonModel")
@:mapping("net.minecraft.class_599")
extern class SalmonModel<T:net.minecraft.world.entity.Entity> extends net.minecraft.client.model.HierarchicalModel<T>
{
  public function new(modelPart:net.minecraft.client.model.geom.ModelPart);
  @:mapping("method_32036")
