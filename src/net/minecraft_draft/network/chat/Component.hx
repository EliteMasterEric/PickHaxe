...
extern interface Component
{
  ...
  public static overload function translatable(key:String, args:Array<Dynamic>):net.minecraft.network.chat.MutableComponent;
  @:badMapping("unknownMethodMapping")
  ...
  public static overload function translatableWithFallback(string:String, string2:Null<String>,
    objects:Array<Dynamic>):net.minecraft.network.chat.MutableComponent;
