...
@:native("net.minecraft.util.datafix.fixes.ItemStackMapIdFix")
@:mapping("net.minecraft.class_1186")
extern class ItemStackMapIdFix extends com.mojang.datafixers.DataFix
{
