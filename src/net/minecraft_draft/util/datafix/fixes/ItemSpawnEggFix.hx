...
@:native("net.minecraft.util.datafix.fixes.ItemSpawnEggFix")
@:mapping("net.minecraft.class_1184")
extern class ItemSpawnEggFix extends com.mojang.datafixers.DataFix
{
