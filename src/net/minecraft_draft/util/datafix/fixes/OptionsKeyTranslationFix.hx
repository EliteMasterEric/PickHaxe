...
@:native("net.minecraft.util.datafix.fixes.OptionsKeyTranslationFix")
@:mapping("net.minecraft.class_1204")
extern class OptionsKeyTranslationFix extends com.mojang.datafixers.DataFix
{
