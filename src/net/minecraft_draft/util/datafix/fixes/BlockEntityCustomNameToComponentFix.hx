...
@:native("net.minecraft.util.datafix.fixes.BlockEntityCustomNameToComponentFix")
@:mapping("net.minecraft.class_3567")
extern class BlockEntityCustomNameToComponentFix extends com.mojang.datafixers.DataFix
{
