...
@:native("net.minecraft.util.datafix.fixes.SavedDataFeaturePoolElementFix")
@:mapping("net.minecraft.class_5947")
extern class SavedDataFeaturePoolElementFix extends com.mojang.datafixers.DataFix
{
