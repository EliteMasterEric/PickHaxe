...
@:native("net.minecraft.util.datafix.schemas.V808")
@:mapping("net.minecraft.class_1252")
extern class V808 extends net.minecraft.util.datafix.schemas.NamespacedSchema
{
