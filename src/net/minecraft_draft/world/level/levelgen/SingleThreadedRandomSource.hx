...
@:native("net.minecraft.world.level.levelgen.SingleThreadedRandomSource")
@:mapping("net.minecraft.class_6575")
extern class SingleThreadedRandomSource implements net.minecraft.world.level.levelgen.BitRandomSource
{
