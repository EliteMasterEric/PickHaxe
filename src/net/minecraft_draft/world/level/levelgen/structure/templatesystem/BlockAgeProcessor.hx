...
@:native("net.minecraft.world.level.levelgen.structure.templatesystem.BlockAgeProcessor")
@:mapping("net.minecraft.class_5193")
extern class BlockAgeProcessor extends net.minecraft.world.level.levelgen.structure.templatesystem.StructureProcessor
{
  @:mapping("field_24997")
  public static final CODEC:com.mojang.serialization.Codec<net.minecraft.world.level.levelgen.structure.templatesystem.BlockAgeProcessor>;
