...
@:native("net.minecraft.world.level.levelgen.structure.pools.EmptyPoolElement")
@:mapping("net.minecraft.class_3777")
extern class EmptyPoolElement extends net.minecraft.world.level.levelgen.structure.pools.StructurePoolElement
{
  @:mapping("field_24947")
  public static final CODEC:com.mojang.serialization.Codec<net.minecraft.world.level.levelgen.structure.pools.EmptyPoolElement>;
  @:mapping("field_16663")
  public static final INSTANCE:net.minecraft.world.level.levelgen.structure.pools.EmptyPoolElement;
