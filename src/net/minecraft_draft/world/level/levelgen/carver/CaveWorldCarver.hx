 ...
 */
@:native("net.minecraft.world.level.levelgen.carver.CaveWorldCarver")
@:mapping("net.minecraft.class_2925")
extern class CaveWorldCarver extends net.minecraft.world.level.levelgen.carver.WorldCarver<net.minecraft.world.level.levelgen.carver.CaveCarverConfiguration>
{
  public function new(codec:com.mojang.serialization.Codec<net.minecraft.world.level.levelgen.carver.CaveCarverConfiguration>);
  @:mapping("method_35358")
  public function isStartChunk(config:net.minecraft.world.level.levelgen.carver.CaveCarverConfiguration, random:net.minecraft.util.RandomSource):Bool;
   ...
   */
  @:mapping("method_35357")
  public function carve(context:net.minecraft.world.level.levelgen.carver.CarvingContext,
    config:net.minecraft.world.level.levelgen.carver.CaveCarverConfiguration, chunk:net.minecraft.world.level.chunk.ChunkAccess,
