...
@:native("net.minecraft.world.level.chunk.GlobalPalette")
@:mapping("net.minecraft.class_2816")
extern class GlobalPalette<T> implements net.minecraft.world.level.chunk.Palette<T>
{
  public function new(idMap:net.minecraft.core.IdMap<T>);
  @:mapping("method_38286")
