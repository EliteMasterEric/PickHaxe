...
@:native("net.minecraft.world.level.block.EnderChestBlock")
@:mapping("net.minecraft.class_2336")
extern class EnderChestBlock extends net.minecraft.world.level.block.AbstractChestBlock<net.minecraft.world.level.block.entity.EnderChestBlockEntity>
