...
@:native("net.minecraft.world.level.block.StandingSignBlock")
@:mapping("net.minecraft.class_2508")
extern class StandingSignBlock extends net.minecraft.world.level.block.SignBlock
{
  @:mapping("field_11559")
