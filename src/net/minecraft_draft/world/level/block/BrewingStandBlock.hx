...
@:native("net.minecraft.world.level.block.BrewingStandBlock")
@:mapping("net.minecraft.class_2260")
extern class BrewingStandBlock extends net.minecraft.world.level.block.BaseEntityBlock
{
  @:mapping("field_10700")
  public static final HAS_BOTTLE:Array<net.minecraft.world.level.block.state.properties.BooleanProperty>;
