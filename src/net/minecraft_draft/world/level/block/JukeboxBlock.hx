...
@:native("net.minecraft.world.level.block.JukeboxBlock")
@:mapping("net.minecraft.class_2387")
extern class JukeboxBlock extends net.minecraft.world.level.block.BaseEntityBlock
{
  @:mapping("field_11180")
  public static final HAS_RECORD:net.minecraft.world.level.block.state.properties.BooleanProperty;
