...
@:native("net.minecraft.world.level.block.FrogspawnBlock")
@:mapping("net.minecraft.class_7113")
extern class FrogspawnBlock extends net.minecraft.world.level.block.Block
{
  ...
  @:mapping("method_41425")
  public static function setHatchDelay(minHatchDelay:Int, maxHatchDelay:Int):Void;
  @:mapping("method_41431")
  public static function setDefaultHatchDelay():Void;
}
