...
@:native("net.minecraft.world.level.block.DragonEggBlock")
@:mapping("net.minecraft.class_2328")
extern class DragonEggBlock extends net.minecraft.world.level.block.FallingBlock
{
