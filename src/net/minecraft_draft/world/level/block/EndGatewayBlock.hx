...
@:native("net.minecraft.world.level.block.EndGatewayBlock")
@:mapping("net.minecraft.class_2329")
extern class EndGatewayBlock extends net.minecraft.world.level.block.BaseEntityBlock
{
