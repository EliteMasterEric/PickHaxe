...
@:native("net.minecraft.world.level.block.BambooSaplingBlock")
@:mapping("net.minecraft.class_2202")
extern class BambooSaplingBlock extends net.minecraft.world.level.block.Block implements net.minecraft.world.level.block.BonemealableBlock
{
