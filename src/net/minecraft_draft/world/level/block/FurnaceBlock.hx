...
@:native("net.minecraft.world.level.block.FurnaceBlock")
@:mapping("net.minecraft.class_3865")
extern class FurnaceBlock extends net.minecraft.world.level.block.AbstractFurnaceBlock
{
