...
@:native("net.minecraft.world.level.block.CaveVinesPlantBlock")
@:mapping("net.minecraft.class_5804")
extern class CaveVinesPlantBlock extends net.minecraft.world.level.block.GrowingPlantBodyBlock implements net.minecraft.world.level.block.BonemealableBlock
