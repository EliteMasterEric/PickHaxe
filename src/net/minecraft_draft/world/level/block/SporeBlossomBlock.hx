...
@:native("net.minecraft.world.level.block.SporeBlossomBlock")
@:mapping("net.minecraft.class_5809")
extern class SporeBlossomBlock extends net.minecraft.world.level.block.Block
{
