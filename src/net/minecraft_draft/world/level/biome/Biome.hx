...
extern class Biome_BiomeBuilder
{
  ...
  public function hasPrecipitation(bl:Bool):net.minecraft.world.level.biome.Biome.Biome_Builder;
  @:mapping("method_8747")
  public function temperature(temperature:Float):net.minecraft.world.level.biome.Biome.Biome_Builder;
  @:mapping("method_8727")
  public function downfall(downfall:Float):net.minecraft.world.level.biome.Biome.Biome_Builder;
  @:mapping("method_24379")
  public function specialEffects(effects:net.minecraft.world.level.biome.BiomeSpecialEffects):net.minecraft.world.level.biome.Biome.Biome_Builder;
  @:mapping("method_30974")
  public function mobSpawnSettings(mobSpawnSettings:net.minecraft.world.level.biome.MobSpawnSettings):net.minecraft.world.level.biome.Biome.Biome_Builder;
  @:mapping("method_30973")
  public function generationSettings(generationSettings:net.minecraft.world.level.biome.BiomeGenerationSettings):net.minecraft.world.level.biome.Biome.Biome_Builder;
  @:mapping("method_30777")
  public function temperatureAdjustment(temperatureSettings:net.minecraft.world.level.biome.Biome.TemperatureModifier):net.minecraft.world.level.biome.Biome.Biome_Builder;
