...
@:native("net.minecraft.world.level.pathfinder.SwimNodeEvaluator")
@:mapping("net.minecraft.class_12")
extern class SwimNodeEvaluator extends net.minecraft.world.level.pathfinder.NodeEvaluator
{
