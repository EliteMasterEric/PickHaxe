...
@:native("net.minecraft.world.item.crafting.ShieldDecorationRecipe")
@:mapping("net.minecraft.class_1872")
extern class ShieldDecorationRecipe extends net.minecraft.world.item.crafting.CustomRecipe
{
