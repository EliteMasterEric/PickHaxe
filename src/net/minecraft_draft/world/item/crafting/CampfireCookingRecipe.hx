...
@:native("net.minecraft.world.item.crafting.CampfireCookingRecipe")
@:mapping("net.minecraft.class_3920")
extern class CampfireCookingRecipe extends net.minecraft.world.item.crafting.AbstractCookingRecipe
{
