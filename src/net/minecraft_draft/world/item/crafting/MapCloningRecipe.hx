...
@:native("net.minecraft.world.item.crafting.MapCloningRecipe")
@:mapping("net.minecraft.class_1855")
extern class MapCloningRecipe extends net.minecraft.world.item.crafting.CustomRecipe
{
