...
@:native("net.minecraft.world.item.enchantment.TridentRiptideEnchantment")
@:mapping("net.minecraft.class_1910")
extern class TridentRiptideEnchantment extends net.minecraft.world.item.enchantment.Enchantment
{
