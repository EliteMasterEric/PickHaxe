...
@:native("net.minecraft.world.item.enchantment.OxygenEnchantment")
@:mapping("net.minecraft.class_1902")
extern class OxygenEnchantment extends net.minecraft.world.item.enchantment.Enchantment
{
